...
const batches = {
    ...
    //     'ArenaPez2', // DJSterlingSilva - Twobert 180
    //     'airbornemoxen', // Eric! (AirborneMoxen) - (+) Semipowered - 450
    //     '1tzjd', // genericname1. -
    //     'gianpeasant', // Gian519 - Synergy
    //     'rbo', // Ianbraverman — 410
    //     // '6ii3', // ilovebaskets - // FIXME: Not found?
    //     'peasants', // Jane (Maramas) -
    //     'OfficialPeasantCube', // Leelue - Official Peasant Cube - Depowered - 450
    //     'naynayscube', // naynay666 - 900
    //     'solar', // Nexon -  Depowered - 420
    //     'pyrpeasant', // pyrrhus - (+)
    //     'ross_scott', // ross_scott - Powered
    //     'saladopeasant', // Salado -
    //     '8ac56c6f-9d25-4548-83f6-e04336db2eec', // shylax -
    //     'peasanttravel', // Squirrely - Travel Cube
    //     'profound', // The Trufflehunter -
    //     'trizeam-peasant', // Trizeam -
    //     '68u', // water the weeds -
...
// FIXME: This needs more intelligence about cache eviction (or at least if a file already exists).
// FIXME: Is it also worth doing sub-caching of individual cubes?
for (const batch of Object.keys(batches)) {
    ...
    fs.writeFileSync(`./preloads/cubes-${batch}.json`, JSON.stringify(batchResult, null, 2));
