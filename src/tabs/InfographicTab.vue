                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostUniqueCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostUniqueCube.id}`" target="_blank" rel="noopener">{{ mostUniqueCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="mostCurrentYearCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostCurrentYearCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostCurrentYearCube.id}`" target="_blank" rel="noopener">{{ mostCurrentYearCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="newestAvgYearCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(newestAvgYearCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${newestAvgYearCube.id}`" target="_blank" rel="noopener">{{ newestAvgYearCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="oldestAvgYearCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(oldestAvgYearCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${oldestAvgYearCube.id}`" target="_blank" rel="noopener">{{ oldestAvgYearCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="mostUniversesBeyondCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostUniversesBeyondCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostUniversesBeyondCube.id}`" target="_blank" rel="noopener">{{ mostUniversesBeyondCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="mostSupplementalProductCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostSupplementalProductCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostSupplementalProductCube.id}`" target="_blank" rel="noopener">{{ mostSupplementalProductCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="highestAvgPopularityCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(highestAvgPopularityCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${highestAvgPopularityCube.id}`" target="_blank" rel="noopener">{{ highestAvgPopularityCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="lowestAvgPopularityCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(lowestAvgPopularityCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${lowestAvgPopularityCube.id}`" target="_blank" rel="noopener">{{ lowestAvgPopularityCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="mostWordyCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostWordyCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostWordyCube.id}`" target="_blank" rel="noopener">{{ mostWordyCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="leastWordyCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(leastWordyCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${leastWordyCube.id}`" target="_blank" rel="noopener">{{ leastWordyCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="mostRemovalCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(mostRemovalCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${mostRemovalCube.id}`" target="_blank" rel="noopener">{{ mostRemovalCube.name }}</a></h4>
                ...
                <el-card class="content-card" v-if="lowestRarityScoreCube">
                    ...
                    <div class="cube-stat">
                        <div class="cube-info-compact">
                            ...
                            <div class="cube-details-compact">
                                <h4><el-icon class="cube-detail-icon" @click="openCubeDetailDialog(lowestRarityScoreCube.id)"><DataAnalysis /></el-icon><a :href="`https://cubecobra.com/cube/list/${lowestRarityScoreCube.id}`" target="_blank" rel="noopener">{{ lowestRarityScoreCube.name }}</a></h4>
