...
export const cardSortProperties: SortProperty[] = [
    ...
    { prop: 'globalRatePercent_total', label: 'Global Rate (All)', autoDirection: 'descending' },
...
export const overviewSortProperties: SortProperty[] = [
    ...
    { prop: 'avgSimilarityScore', label: 'Avg. Similarity', autoDirection: 'descending' },
    ...
    { prop: 'stats.averageWordCountUnique', label: 'Avg. Word Count (Unique)', autoDirection: 'descending' },
    ...
    { prop: 'stats.uniqueTokenCount', label: 'Unique Tokens', autoDirection: 'descending' },
    ...
    { prop: 'stats.averagePopularity', label: 'Avg. Popularity', autoDirection: 'descending' },
    { prop: 'stats.cardCounts.abnormalLayout', label: 'Abnormal Layout', autoDirection: 'descending' },
